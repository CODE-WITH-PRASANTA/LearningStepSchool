...
const StudentGatepassPrint = () => {
  ...
  const downloadPDF = async () => {
    ...
    pdf.save(
      `GatePass-${visitor?.id || "Student"}.pdf`
    );
  };
  ...
  return (
    <div className="studentGatepassPrint">
      ...
      <div
        ref={pdfRef}
        className="studentGatepassPrint__document"
      >
        ...
        <div className="studentGatepassPrint__heading">
          STUDENT GATE PASS
        </div>
        ...
        <div className="studentGatepassPrint__note">
          ...
          Learning Step School and must be
          presented to the security staff
