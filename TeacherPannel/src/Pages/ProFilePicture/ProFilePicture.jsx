    ...
    <div className="ProfilePage">
      <div className="ProfilePage__container">
        ...
        <div className="ProfilePage__header">
          ...
          <p className="ProfilePage__subtitle">Manage your personal information</p>
        </div>
          ...
          <form className="ProfilePage__formCard" onSubmit={handleSubmit}>
            <div className="ProfilePage__grid">
              ...
              <div className="ProfilePage__field">
                ...
                <input name="name" value={profile.name} onChange={handleChange}
                  className="ProfilePage__input ProfilePage__input--disabled" disabled />
              </div>
            ...
            <div className="ProfilePage__field" style={{ marginTop: 14 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {(profile.permissions || []).length === 0 ? (
                  <span style={{ color: "rgba(15,23,42,0.55)", fontSize: 13 }}>No permissions assigned</span>
                ) : (
                  profile.permissions.map((p) => (
                    <span key={p} style={{
                      background: "rgba(43,106,243,0.10)", border: "1px solid rgba(43,106,243,0.18)",
                      color: "rgba(35,79,190,0.95)", borderRadius: 999, padding: "5px 10px",
            ...
            <div className="ProfilePage__field">
              ...
              <textarea name="bio" value={profile.bio} onChange={handleChange}
                className="ProfilePage__input ProfilePage__textarea ProfilePage__input--disabled" disabled />
            </div>
        ...
        <div className="LeaveSection">
          ...
          <div className="LeaveSection__heading">
            ...
            <div>
              ...
              <p className="LeaveSection__subtitle">Apply for leave and track your requests</p>
            </div>
          </div>
          ...
          <div className="LeaveSection__tabs">
            ...
            >
              ...
              {leaveHistory.length > 0 && (
                <span className="LeaveSection__tabBadge">{leaveHistory.length}</span>
              )}
            </button>
          </div>
          ...
          {leaveTab === "form" && (
            <form className="LeaveForm" onSubmit={handleLeaveSubmit}>
              ...
              <div className="LeaveForm__grid">
                {/* Leave Type */}
                <div className="ProfilePage__field">
                  <label className="ProfilePage__label">Leave Type <span className="LeaveForm__required">*</span></label>
                  <select
                    name="leaveType"
                ...
                {/* From Date */}
                <div className="ProfilePage__field">
                  <label className="ProfilePage__label">From Date <span className="LeaveForm__required">*</span></label>
                  <input
                    type="date"
                    name="fromDate"
                ...
                {/* To Date */}
                <div className="ProfilePage__field">
                  <label className="ProfilePage__label">To Date <span className="LeaveForm__required">*</span></label>
                  <input
                    type="date"
                    name="toDate"
                ...
                {leaveForm.fromDate && leaveForm.toDate && (
                  <div className="ProfilePage__field LeaveForm__daysBadge">
                    <span>
                      📅 Duration: <strong>{calcDays(leaveForm.fromDate, leaveForm.toDate)} day(s)</strong>
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="ProfilePage__actions" style={{ marginTop: 18 }}>
                <button type="submit" className="LeaveForm__submitBtn" disabled={leaveLoading}>
                  {leaveLoading ? (
              ...
              {leaveHistory.length === 0 ? (
                ...
                <div className="LeaveHistory__list">
                  {leaveHistory.map((leave, idx) => (
                    <div key={leave._id || idx} className="LeaveHistory__card">
                        ...
                        <div>
                          ...
                          <span className="LeaveHistory__dates">
                            ...
                            <span className="LeaveHistory__days">
                              ({calcDays(leave.fromDate?.slice(0, 10), leave.toDate?.slice(0, 10))} day(s))
                            </span>
                          </span>
                        </div>
                        <span
                          className="LeaveHistory__status"
                          style={STATUS_STYLES[leave.status] || STATUS_STYLES.pending}
                        >
                          {leave.status
